...
function Clock() {
    ...
    const stringTime =  normalizeTime(date.getHours()) + ":" + normalizeTime(date.getMinutes()-1)|| <br/> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
